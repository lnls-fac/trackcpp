...
//   int elem_offset = element_offset;
//   for (size_t i = 0; i < nr_elements; i++) {
//       auto elem = this->lattice[elem_offset];
//       if (PMClass.is_time_aware_pm(elem.pass_method)) {TAW_indices.push_back(i);}
//       elem_offset = (elem_offset + 1) % nr_elements;
//   }
//   double s_pos = 0.0;
...
//   double s_pos = 0.0;
//   for (size_t i = element_offset; i < nr_elements; i++) {
//       auto elem = this->lattice[i];
//       s_pos += elem.length;
//       if (PMClass.is_time_aware_pm(elem.pass_method)) {
...
//     if (PMClass.is_time_aware_pm(elem.pass_method)) {
//       TAW_indices.push_back(i);
//       temp_pos.push_back(s_pos);
//       s_pos = 0.0;
//       }
//   }
//   temp_pos.push_back(s_pos);

//   TAW_positions[0] += temp_pos.back();
//   temp_pos.pop_back();

//   if (temp_pos.size() >= 1) {
//     TAW_positions.back() += temp_pos[0];
//     temp_pos.erase(temp_pos.begin());
//   }
//   if (TAW_positions.size() > TAW_indices.size()) {
//     TAW_positions[0] += TAW_positions.back();
//     TAW_positions.pop_back();
//   }
//   for (double s: temp_pos) {
//     TAW_positions.push_back(s);
//   }
//   s_pos = 0.0;
//   for (double s: TAW_positions) {
//     s_pos += s;
//   }
//   temp_pos.clear();
