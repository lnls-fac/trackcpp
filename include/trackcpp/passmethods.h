...
template <typename T> Status::type pm_cavity_1_pass              (Pos<T> &pos, const Element &elem, const Accelerator& accelerator, const double nturn = 0.0);
template <typename T> Status::type pm_cavity_2_pass              (Pos<T> &pos, const Element &elem, const Accelerator& accelerator);
template <typename T> Status::type pm_cavity_3_pass              (Pos<T> &pos, const Element &elem, const Accelerator& accelerator);
template <typename T> Status::type pm_cavity_4_pass              (Pos<T> &pos, const Element &elem, const Accelerator& accelerator);
template <typename T> Status::type pm_cavity_5_pass              (Pos<T> &pos, const Element &elem, const Accelerator& accelerator);
