...
int main() {
    ...
    sirius.energy = 3e9;
    sirius.harmonic_number = 864;
    sirius.cavity_on = true;
    sirius.radiation_on = true;
    sirius.vchamber_on = true;

    sirius_v500(sirius.lattice);

    track_findm66(sirius, fp, tm, m66, v0); //, indices);

    std::cout << m66 << std::endl;
